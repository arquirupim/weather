import '../resource/css/searchGeo.css'
import { ReactElement } from 'react'
import { loadingstore, weatherStore } from '../resource/js/store'
import {getLocation} from '../resource/js/common'
import { useNavigate } from 'react-router-dom'

function SearchGeo() : ReactElement{
    ...
    return(
        <div className ='geoWrap' onClick={getWeather}>
            <div className='iconWrap'>
                <svg className='geoIcon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
